...
class TestCancelSale:
    def test_cancel_completed_sale_returns_stock(
        self, db, cashier, supervisor, product_a
    ):
        sale = SaleService.create_sale(
            cashier=cashier,
            items=[{"product_id": product_a.id, "quantity": 10}],
    ...
    def test_cancel_sale_sets_cancelled_status(
        self, db, cashier, supervisor, product_a
    ):
        sale = SaleService.create_sale(
            cashier=cashier,
    ...
    def test_cancel_already_cancelled_sale_raises(
        self, db, cashier, supervisor, product_a
    ):
        sale = SaleService.create_sale(
            cashier=cashier,
