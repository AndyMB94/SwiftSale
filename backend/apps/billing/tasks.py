...
def generate_and_send_receipt(self, billing_document_id: str):
    ...
    try:
        ...
        logger.error('BillingDocument %s not found — skipping receipt', billing_document_id)
        return
    ...
    if not customer_email:
        logger.info('No customer email for document %s — skipping email', doc.full_number)
